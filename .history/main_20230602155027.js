...
ul.addEventListener('click',(e)=>{
    ...
    const {title} = modalMove[0];
    console.log(modalMove[0],title);
...
function modalTemplate(title,time,age,director,actor,descrpition){
    return `
    ...
    <section class="modal__card">
        ...
        <div class="modal__txt">
            ...
            <p class="descrpition">${descrpition}</p>
            </div>
    </section>
</div>
    `
